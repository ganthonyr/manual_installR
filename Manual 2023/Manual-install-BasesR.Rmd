...
subtitle: "Curso: «Bases de R para manejo y análisis de datos»"
output:
...
::: text-justify
Antes de instalar R(v4.2.2), debemos ir al sitio web de [CRAN](https://cran.r-project.org/bin/windows/base/) para descargar el programa dando click en "**Download R 4.2.2 for Windows**". <br>
:::
...
::: text-justify
Al igual que en la sección anterior, para instalar la versión 2022.12.0+353. de nuestro IDE, primero vamos a la página oficial de [Rstudio](https://www.rstudio.com/products/rstudio/download/), escogemos la opción "**Free**" y damos click en "**download RStudio for Windows**".<br>
:::
...
<br> <br> \_\_\_ <br> **Manual elaborado por:** <br> [Anthony Romero Cerdán](https://github.com/ganthonyr) _(anthony.romeromh\@gmail.com)_ <br>
_La versión original de este manual fue tomada del manual elaborado para [InkaStats Academy](https://www.facebook.com/InkaStats.DSS)_ <br>
\.\.\.